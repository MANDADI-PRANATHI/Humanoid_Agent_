...
def main():
    ...
    parser.add_argument("--model_folder", "-m", default="/home/prana/openpose/models/", help="OpenPose models folder")
    ...
    if res.theta_init_vector is not None:
        print("Theta init vector (placeholder):", res.theta_init_vector)
